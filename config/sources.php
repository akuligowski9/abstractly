...
return [
    ...
    'list' => [
        ...
        [
            ...
            'kind'        => 'primary',
            'disciplines' => ['math'],
            'url'         => 'https://export.arxiv.org/api/query?search_query=cat:math.*&sortBy=submittedDate&sortOrder=descending&max_results=25',
        ...
        [
            ...
            'kind' => 'primary',
            'disciplines' => ['math'],
            'url' => 'https://export.arxiv.org/api/query?search_query=cat:math.AG&sortBy=submittedDate&sortOrder=descending&max_results=15',
            'signal' => 'latest preprints',
            'notes' => 'Subfield feed.',
        ],
        [
            ...
            'kind' => 'primary',
            'disciplines' => ['math'],
            'url' => 'https://export.arxiv.org/api/query?search_query=cat:math.AT&sortBy=submittedDate&sortOrder=descending&max_results=15',
            'signal' => 'latest preprints',
            'notes' => 'Subfield feed.',
        ],
        [
            ...
            'kind' => 'primary',
            'disciplines' => ['math'],
            'url' => 'https://export.arxiv.org/api/query?search_query=cat:math.CO&sortBy=submittedDate&sortOrder=descending&max_results=15',
            'signal' => 'latest preprints',
            'notes' => 'Subfield feed.',
        ],
        [
            ...
            'kind' => 'primary',
            'disciplines' => ['math'],
            'url' => 'https://export.arxiv.org/api/query?search_query=cat:math.DG&sortBy=submittedDate&sortOrder=descending&max_results=15',
            'signal' => 'latest preprints',
            'notes' => 'Subfield feed.',
        ],
        [
            ...
            'kind' => 'primary',
            'disciplines' => ['math'],
            'url' => 'https://export.arxiv.org/api/query?search_query=cat:math.FA&sortBy=submittedDate&sortOrder=descending&max_results=15',
            'signal' => 'latest preprints',
            'notes' => 'Subfield feed.',
        ],
        [
            ...
            'kind' => 'primary',
            'disciplines' => ['math'],
            'url' => 'https://export.arxiv.org/api/query?search_query=cat:math.GT&sortBy=submittedDate&sortOrder=descending&max_results=15',
            'signal' => 'latest preprints',
            'notes' => 'Subfield feed.',
        ],
        [
            ...
            'kind' => 'primary',
            'disciplines' => ['math'],
            'url' => 'https://export.arxiv.org/api/query?search_query=cat:math.NT&sortBy=submittedDate&sortOrder=descending&max_results=15',
            'signal' => 'latest preprints',
            'notes' => 'Subfield feed.',
        ],
        [
            ...
            'kind' => 'primary',
            'disciplines' => ['math'],
            'url' => 'https://export.arxiv.org/api/query?search_query=cat:math.PR&sortBy=submittedDate&sortOrder=descending&max_results=15',
            'signal' => 'latest preprints',
            'notes' => 'Subfield feed.',
        ],
        [
            ...
            'kind' => 'primary',
            'disciplines' => ['math'],
            'url' => 'https://export.arxiv.org/api/query?search_query=cat:math.RA&sortBy=submittedDate&sortOrder=descending&max_results=15',
            'signal' => 'latest preprints',
            'notes' => 'Subfield feed.',
        ],
        [
            ...
            'kind' => 'primary',
            'disciplines' => ['math'],
            'url' => 'https://export.arxiv.org/api/query?search_query=cat:math.RT&sortBy=submittedDate&sortOrder=descending&max_results=15',
            'signal' => 'latest preprints',
            'notes' => 'Subfield feed.',
        ],
        [
            ...
            'kind' => 'primary',
            'disciplines' => ['math'],
            'url' => 'https://export.arxiv.org/api/query?search_query=cat:math.OC&sortBy=submittedDate&sortOrder=descending&max_results=15',
            'signal' => 'latest preprints',
            'notes' => 'Subfield feed.',
        ],
        [
            ...
            'kind' => 'primary',
            'disciplines' => ['math'],
            'url' => 'https://export.arxiv.org/api/query?search_query=cat:math.NA&sortBy=submittedDate&sortOrder=descending&max_results=15',
            'signal' => 'latest preprints',
            'notes' => 'Subfield feed.',
        ],
        [
        ...
        [
            ...
            'kind' => 'primary',
            'disciplines' => ['math'],
            'url' => 'https://export.arxiv.org/api/query?search_query=cat:math.ST&sortBy=submittedDate&sortOrder=descending&max_results=15',
            'signal' => 'latest preprints',
            'notes' => 'Subfield feed.',
        ],
        ...
        [
            ...
            'kind'        => 'primary',
            'disciplines' => ['cs'],
            'url'         => 'https://export.arxiv.org/api/query?search_query=cat:cs.*&sortBy=submittedDate&sortOrder=descending&max_results=25',
            'signal'      => 'latest preprints',
        ...
        [
            ...
            'kind'        => 'primary',
            'disciplines' => ['cs'],
            'url'         => 'https://export.arxiv.org/api/query?search_query=cat:cs.LG&sortBy=submittedDate&sortOrder=descending&max_results=15',
            'signal'      => 'latest preprints',
            'notes'       => 'Subfield feed.',
        ],
        [
        ...
        [
            ...
            'kind'        => 'primary',
            'disciplines' => ['cs'],
            'url'         => 'https://export.arxiv.org/api/query?search_query=cat:cs.SE&sortBy=submittedDate&sortOrder=descending&max_results=15',
            'signal'      => 'latest preprints',
            'notes'       => 'Subfield feed.',
        ],
        [
        ...
        [
            ...
            'kind'        => 'primary',
            'disciplines' => ['cs'],
            'url'         => 'https://export.arxiv.org/api/query?search_query=cat:cs.DC&sortBy=submittedDate&sortOrder=descending&max_results=15',
            'signal'      => 'latest preprints',
            'notes'       => 'Subfield feed.',
        ],
        [
            ...
            'kind'        => 'primary',
            'disciplines' => ['cs'],
            'url'         => 'https://export.arxiv.org/api/query?search_query=cat:cs.PL&sortBy=submittedDate&sortOrder=descending&max_results=15',
            'signal'      => 'latest preprints',
            'notes'       => 'Subfield feed.',
        ],
        ...
        [
            ...
            'url'         => 'https://export.arxiv.org/api/query?search_query=cat:q-bio.NC&sortBy=submittedDate&sortOrder=descending&max_results=15',
            'signal'      => 'latest preprints',
        ...
        [
            ...
            'kind'        => 'primary',
            'disciplines' => ['earth'],
            'url'         => 'https://export.arxiv.org/api/query?search_query=cat:physics.ao-ph&sortBy=submittedDate&sortOrder=descending&max_results=15',
            'signal'      => 'latest preprints',
        ...
        [
            ...
            'kind'        => 'primary',
            'disciplines' => ['earth'],
            'url'         => 'https://export.arxiv.org/api/query?search_query=cat:physics.geo-ph&sortBy=submittedDate&sortOrder=descending&max_results=15',
            'signal'      => 'latest preprints',
        ...
        [
            ...
            'kind'        => 'primary',
            'disciplines' => ['earth'],
            'url'         => 'https://export.arxiv.org/api/query?search_query=cat:astro-ph.EP&sortBy=submittedDate&sortOrder=descending&max_results=15',
            'signal'      => 'latest preprints',
        ...
        [
            ...
            'url'         => 'https://export.arxiv.org/api/query?search_query=cat:econ.GN&sortBy=submittedDate&sortOrder=descending&max_results=15',
            'signal'      => 'latest preprints',
        ...
        [
            ...
            'kind'        => 'primary',
            'disciplines' => ['economics'],
            'url'         => 'https://export.arxiv.org/api/query?search_query=cat:econ.EM&sortBy=submittedDate&sortOrder=descending&max_results=15',
            'signal'      => 'latest preprints',
        ...
        [
            ...
            'kind'        => 'primary',
            'disciplines' => ['economics'],
            'url'         => 'https://export.arxiv.org/api/query?search_query=cat:econ.TH&sortBy=submittedDate&sortOrder=descending&max_results=15',
            'signal'      => 'latest preprints',
        ...
        [
            ...
            'kind'        => 'primary',
            'disciplines' => ['economics'],
            'url'         => 'https://export.arxiv.org/api/query?search_query=cat:q-fin.*&sortBy=submittedDate&sortOrder=descending&max_results=15',
            'signal'      => 'latest preprints',
        ...
        [
            ...
            'url'         => 'https://export.arxiv.org/api/query?search_query=cat:q-bio.BM&sortBy=submittedDate&sortOrder=descending&max_results=15',
            'signal'      => 'latest preprints',
        ...
        [
            ...
            'url'         => 'https://export.arxiv.org/api/query?search_query=cat:q-bio.QM&sortBy=submittedDate&sortOrder=descending&max_results=15',
            'signal'      => 'latest preprints',
        ...
        [
            ...
            'kind'        => 'primary',
            'disciplines' => ['informatics'],
            'url'         => 'https://export.arxiv.org/api/query?search_query=cat:q-bio.GN&sortBy=submittedDate&sortOrder=descending&max_results=15',
            'signal'      => 'latest preprints',
        ...
        [
            ...
            'kind'        => 'primary',
            'disciplines' => ['informatics'],
            'url'         => 'https://export.arxiv.org/api/query?search_query=cat:q-bio.MN&sortBy=submittedDate&sortOrder=descending&max_results=15',
            'signal'      => 'latest preprints',
        ...
        [
            ...
            'url'         => 'https://export.arxiv.org/api/query?search_query=cat:eess.SP&sortBy=submittedDate&sortOrder=descending&max_results=15',
            'signal'      => 'latest preprints',
        ...
        [
            ...
            'kind'        => 'primary',
            'disciplines' => ['engineering'],
            'url'         => 'https://export.arxiv.org/api/query?search_query=cat:eess.SY&sortBy=submittedDate&sortOrder=descending&max_results=15',
            'signal'      => 'latest preprints',
        ...
        [
            ...
            'kind'        => 'primary',
            'disciplines' => ['engineering'],
            'url'         => 'https://export.arxiv.org/api/query?search_query=cat:cs.RO&sortBy=submittedDate&sortOrder=descending&max_results=15',
            'signal'      => 'latest preprints',
        ...
        [
            ...
            'url'         => 'https://export.arxiv.org/api/query?search_query=cat:q-bio.PE&sortBy=submittedDate&sortOrder=descending&max_results=15',
            'signal'      => 'latest preprints',
